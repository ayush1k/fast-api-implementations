...
@app.get('/sort')
def sort_patients(sort_by:str = Query(..., description='Sort in the basis of height, weight or bmi'), order:str = Query('asc', description='Sort in ascending or descending order')):
